    ...
    <div className="footer">
      <div className="footer-content">
        <div className="col">
          ...
          <div className="text">
            Voluptatem accusantium dolaremque laudentium, totam rem aperisam,
            eaque ipsa quae ab illo incentore veritatis et quasi architector
            berate vitae dicta sunt explicabo eaque ipsa quae ab illo
          </div>
        </div>
        <div className="col">
